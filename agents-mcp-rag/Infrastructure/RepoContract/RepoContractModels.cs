...
internal enum FrontendLayoutMode
{
...
internal sealed record PathPlacementRule(string FileSuffix, string Directory, Func<string, bool>? FileFilter);

internal sealed record EntityConvention(
...
internal sealed record FrontendModuleTemplate(
    string ModulesRoot,
...
internal sealed class RepoContract
{
